...
proc create_root_design { parentCell } {
  ...
  # Create instance: sodor_artix_0, and set properties
  set sodor_artix_0 [ create_bd_cell -type ip -vlnv user.org:user:sodor_artix:1.0 sodor_artix_0 ]
 ...
 ] [get_bd_intf_pins /sodor_artix_0/m00_axi]
  ...
  connect_bd_intf_net -intf_net sodor_artix_0_m00_axi [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins sodor_artix_0/m00_axi]
  ...
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out3] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins sodor_artix_0/m00_axi_aclk]
  ...
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_83M/slowest_sync_clk]
  ...
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins sodor_artix_0/m00_axi_aresetn]
  ...
  connect_bd_net -net rst_mig_7series_0_83M_interconnect_aresetn [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins rst_mig_7series_0_83M/interconnect_aresetn]
  ...
  connect_bd_net -net rxd_0_1 [get_bd_ports rxd] [get_bd_pins sodor_artix_0/rxd]
  connect_bd_net -net sodor_artix_0_txd [get_bd_ports txd] [get_bd_pins sodor_artix_0/txd]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1]

  # Create address segments
  create_bd_addr_seg -range 0x10000000 -offset 0x10000000 [get_bd_addr_spaces sodor_artix_0/m00_axi] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
