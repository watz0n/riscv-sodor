...
Sodor is also ported to FPGA([PYNQ-Z1](http://store.digilentinc.com/pynq-z1-python-productivity-for-zynq/)) wherein 3stage core is used 
...
for more details check [README](https://github.com/librecores/riscv-sodor/blob/fpga/emulator/fpgazynq/README.md). Apart from emulating sodor on FPGA, 
the surrounding that 3stage faces on FPGA, can also be simulated in software [zynqsimtop](https://github.com/librecores/riscv-sodor/tree/fpga/emulator/zynqsimtop). 
...
See doc/ for microarchitecture diagrams which can be viewed using [draw.io](https://www.draw.io) using the following example link https://www.draw.io/?url=https://raw.githubusercontent.com/librecores/riscv-sodor/master/doc/fpga.xml with doc/fpga.xml to be changed as desired
